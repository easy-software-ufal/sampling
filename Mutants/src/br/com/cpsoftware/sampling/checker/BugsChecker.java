...
public class BugsChecker {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(checker.bugs);
		...
		checker.checkSampling(new OneDisabledSampling());
		System.out.println(checker.bugs);
		...
		checker.checkSampling(new AllEnabledDisabledSampling());
		System.out.println(checker.bugs);
		end = System.currentTimeMillis();
		System.out.println("Time: " + (end-start) + "\n");
		...
		checker.checkSampling(new TwiseSampling(2));
		System.out.println(checker.bugs);
		end = System.currentTimeMillis();
		System.out.println("Time: " + (end-start) + "\n");
		...
		checker.checkSampling(new TwiseSampling(3));
		System.out.println(checker.bugs);
		end = System.currentTimeMillis();
		System.out.println("Time: " + (end-start) + "\n");
		...
		checker.checkSampling(new TwiseSampling(4));
		System.out.println(checker.bugs);
		end = System.currentTimeMillis();
		System.out.println("Time: " + (end-start) + "\n");
		...
		checker.checkSampling(new TwiseSampling(5));
		System.out.println(checker.bugs);
		end = System.currentTimeMillis();
		System.out.println("Time: " + (end-start) + "\n");
		...
		checker.checkSampling(new TwiseSampling(6));
		System.out.println(checker.bugs);
		end = System.currentTimeMillis();
		System.out.println("Time: " + (end-start) + "\n");
	}
